...
import ifgoiano.estudante.rodrigues.angel.algoritmosOrdenacao.MergeSort;
import ifgoiano.estudante.rodrigues.angel.algoritmosOrdenacao.QuickSort;
...
public class MergeSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byMergeSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = MergeSort.realizar(dados); // sorting and getting the moviments number
