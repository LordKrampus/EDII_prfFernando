...
import ifgoiano.estudante.rodrigues.angel.algoritmosOrdenacao.InsertionSort;
...
public class InsertionSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byInsertionSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = InsertionSort.realizar(dados); // sorting and getting the moviments number
