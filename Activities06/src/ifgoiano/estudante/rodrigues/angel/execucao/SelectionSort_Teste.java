...
import ifgoiano.estudante.rodrigues.angel.algoritmosOrdenacao.SelectionSort;
...
public class SelectionSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\bySelectionSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = SelectionSort.realizar(dados); // sorting
