...
import ifgoiano.estudante.rodrigues.angel.algoritmosOrdenacao.ShellSort;
...
public class ShellSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byShellSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = ShellSort.realizar(dados); // sorting and getting the moviments number
