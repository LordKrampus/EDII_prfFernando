...
public class RadixSort_Teste {
    ...
    public static void main(String[] args){
        ...
        //realizarOrdenacao("arquivoDeTestes_quickSort.txt", "arquivoDeTestes.txt");
    }
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byRadixSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = SortAlgorithmsControl.radixSort(dados); // sorting and getting the moviments number
