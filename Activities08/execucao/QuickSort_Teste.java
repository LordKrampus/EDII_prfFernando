...
public class QuickSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byQuickSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = SortAlgorithmsControl.quickSort(dados); // sorting and getting the moviments number
