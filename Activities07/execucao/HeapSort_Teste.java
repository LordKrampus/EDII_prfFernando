...
public class HeapSort_Teste {
    ...
    public static void realizarOrdenacao(String nomeFrom, String nomeTo){
        ...
        String pathTo = absolutePath + "\\src\\ifgoiano\\estudante\\rodrigues\\angel\\conjuntoDados\\ordenados\\byHeapSort\\" + nomeTo;
        Integer[] dados;
        double timer;
        long numMovimentos;
        ...
        try {
            ...
            numMovimentos = SortAlgorithmsControl.heapSort(dados); // sorting and getting the moviments number
